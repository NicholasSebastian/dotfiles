return {
  ...
  spectre = function()
    ...
    vim.keymap.set("n", "<leader>S", open_spectre, { desc = "Open Find and Replace Window" })
    vim.keymap.set("n", "<leader>sw", spectre_current_n, { desc = "Search current word" })
    vim.keymap.set("v", "<leader>sw", spectre_current_v, { desc = "Search current word" })
    vim.keymap.set("n", "<leader>sp", spectre_file, { desc = "Search on current file" })
  end,
}
